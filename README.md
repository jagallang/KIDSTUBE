...
- 🚀 **성능 최적화**: Selector 패턴을 통한 효율적인 상태 관리
...
dependencies:
  ...
  flutter_inappwebview: ^6.1.5  # 비디오 재생
  crypto: ^3.0.6             # PIN 암호화
```
...
### 4. 성능 최적화
- Selector 패턴으로 불필요한 위젯 리빌드 방지
- 이미지 캐싱으로 네트워크 사용량 최소화
- 비디오 목록 지연 로딩
