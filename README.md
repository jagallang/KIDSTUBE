...
### v1.0.x - 프론트엔드 독립형 (Frontend Standalone)
- **브랜치**: `v1.0-standalone`
- **특징**: 개인 API 키를 사용하는 독립 실행형 앱
- **대상**: 개인 사용자가 자신의 YouTube API 키로 직접 운영

### v2.0.x - 백엔드 통합형 (Backend Integration)
- **브랜치**: `v2.0-backend-integration`
...
### Clean Architecture + Backend Integration System (v2.0.x)
